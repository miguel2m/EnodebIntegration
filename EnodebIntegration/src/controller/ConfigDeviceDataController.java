...
public class ConfigDeviceDataController extends BaseController implements Initializable {
    ...
    private ObservableList<TableSixDeviceData> _tableSixDeviceData = FXCollections.observableArrayList();
    ...
    @FXML
    void onAddTableSixDeviceData(ActionEvent event) {

    }

    @FXML
    void onDeleteTableSixDeviceData(ActionEvent event) {

    }

    @FXML
    void onUpdateTableSixDeviceData(ActionEvent event) {
